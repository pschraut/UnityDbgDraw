...
namespace Oddworm.Framework
{
    public partial class DbgDraw
    {
        ...
        public static void Quad(Vector3 position, Quaternion rotation, Vector3 scale, Color color, float duration = 0, bool depthTest = true)
        {
            PrimitiveJob job;
            if (!TryAllocPrimitiveJob(out job, GL.QUADS, duration, depthTest, UnityEngine.Rendering.CullMode.Off, true))
                return;
